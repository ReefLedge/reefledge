...
setup(
    ...
    download_url='https://github.com/Reefledge/reefledge/archive/refs/tags/v1.4.0' + '-beta.8.tar.gz',
    ...
    install_requires=['setuptools>=50.3.2,<64.0.0', 'requests>=2.27.1,<3.0.0', 'psycopg2>=2.9.3,<3.0.0', 'numpy>=1.22.4,<1.23.0', 'scipy>=1.8.1,<1.10.0', 'pandas>=1.4.2,<1.5.0', 'matplotlib>=3.5.2,<3.6.0', 'openpyxl>=3.0.10,<3.1.0', 'ipython>=7.34.0,<9.0.0', 'ipykernel>=5.5.6,<7.0.0', 'nptyping>=2.2.0,<3.0.0', 'psutil>=5.9.1,<6.0.0', 'python-dateutil>=2.8.2,<3.0.0', 'pydantic>=1.9.1,<1.10.0', 'cryptography>=36.0.2,<38.0.0', 'backoff>=1.11.1,<3.0.0', 'cachetools>=4.2.4,<6.0.0', 'pyqt5', 'xlwings==0.27.10',],
