...
setup(
    ...
    download_url='https://github.com/Reefledge/reefledge/archive/refs/tags/v1.1.6-beta.1.tar.gz',
    keywords=['quant', 'finance', 'api', 'forecasting', 'time-series', 'machine learning', 'trading', 'portfolio management', 'risk management'],
    install_requires=['setuptools>=50.3.1', 'cython>=0.29.22', 'requests>=2.25.1', 'twilio>=6.50.1', 'psycopg2>=2.8.6', 'numpy>=1.18.5', 'scipy>=1.5.0', 'pandas>=1.0.5', 'matplotlib>=3.2.2', 'openpyxl>=3.0.5', 'ipython>=7.19.0', 'ipykernel>=5.3.4', 'nptyping>=1.4.0', 'psutil>=5.8.0', 'python-dateutil>=2.8.1', 'pdoc3>=0.10.0', 'pydantic>=1.8.2', 'pyqt5', 'xlwings==0.25.0',],
