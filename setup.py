...
setup(
    ...
    version='1.4.0' + '-beta.0' # Do NOT use double quotes',
    ...
    download_url='https://github.com/Reefledge/reefledge/archive/refs/tags/v1.4.0' + '-beta.0' # Do NOT use double quotes.tar.gz',
