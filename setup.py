...
setup(
    ...
    download_url='https://github.com/Reefledge/reefledge/archive/refs/tags/v1.2.2-beta.1.tar.gz',
    ...
    install_requires=['setuptools>=50.3.1,<51.0.0', 'cython>=0.29.22,<1.0.0', 'requests>=2.25.1,<3.0.0', 'twilio>=6.50.1,<7.0.0', 'psycopg2>=2.8.6,<3.0.0', 'numpy>=1.18.5,<2.0.0', 'scipy>=1.5.0,<2.0.0', 'pandas>=1.0.5,<2.0.0', 'matplotlib>=3.2.2,<4.0.0', 'openpyxl>=3.0.5,<4.0.0', 'ipython>=7.19.0,<8.0.0', 'ipykernel>=5.3.4,<6.0.0', 'nptyping>=1.4.0,<2.0.0', 'psutil>=5.8.0,<6.0.0', 'python-dateutil>=2.8.1,<3.0.0', 'pdoc3>=0.10.0,<1.0.0', 'pydantic>=1.8.2,<2.0.0', 'pyqt5', 'xlwings==0.25.0',],
